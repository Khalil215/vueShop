...
const handleSubmit = async(e)=>{
  try{
    loading.value = true
    await store.dispatch('signup', {email: email.value, password: password.value, firstName:firstName.value, lastName:lastName.value, username:username.value })
    loading.value = false
    router.push('/')
  }catch(err){
